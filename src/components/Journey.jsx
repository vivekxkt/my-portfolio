...
function JourneyCard({ item, align, index }) {
  ...
  return (
    // ✅ Motion wrapper for animation (keeps blur flicker-free)
    <motion.div
          ...
          {items.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Left or Right Card */}
                {left ? (
                  <JourneyCard item={item} align="left" index={i} />
                ) : (
                  <div></div>
                )}

                {!left ? (
                  <JourneyCard item={item} align="right" index={i} />
                ) : (
                  <div></div>
                )}
              </div>
